...
const contenido = document.getElementById('contenido').content

const fragment = document.createDocumentFragment()


function crearCard (arreglo){
  arreglo.forEach(animal => {
    
  contenido.querySelector('#name').textContent = animal
...
const arreglo = animales.filter((animal )=> animal.color=="Negro").map(function(animal){return animal.name})
